import { K3Instance } from '../build/contract-interfaces'
import { fundContract } from './helpers.js'

const K3 = artifacts.require("K3")

contract('K3', ([deployer, account1]) => {
  let instance:K3Instance
  ...
  beforeEach(async () => {
    instance = await K3.new(owner, account1)
  })
