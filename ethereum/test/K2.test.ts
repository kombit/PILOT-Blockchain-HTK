import { K2Instance } from '../build/contract-interfaces'
import { fundContract } from './helpers.js'

const K2 = artifacts.require("K2")

contract('K2', ([deployer, account1]) => {
  let instance:K2Instance
  ...
  beforeEach(async () => {
    instance = await K2.new(owner, account1)
  })
