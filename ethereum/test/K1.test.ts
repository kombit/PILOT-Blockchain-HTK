import { K1Instance } from '../build/contract-interfaces'
import { fundContract } from './helpers.js'

const K1 = artifacts.require("K1")

contract('K1', ([deployer, account1]) => {
  let instance:K1Instance
  ...
  beforeEach(async () => {
    instance = await K1.new(owner, account1)
  })
