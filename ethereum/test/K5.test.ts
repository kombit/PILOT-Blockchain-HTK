import { K5Instance } from '../build/contract-interfaces'
import { fundContract } from './helpers.js'

const K5 = artifacts.require("K5")

contract('K5', ([deployer, account1]) => {
  let instance:K5Instance
  ...
  beforeEach(async () => {
    instance = await K5.new(owner, account1)
  })
